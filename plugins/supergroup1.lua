...
local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = 'SuperGroup Protected With Grenade Succesfully !'
	...
	local data = load_data(_config.moderation.data)
		...
		if matches[1] == 'id' then
			...
			elseif msg.text:match("@[%a%d]") then
				...
				return "#Your_ID: "..msg.from.id.."\n#Your_UserName : "..msg.from.username.."\n#SuperGroup_Name: " ..string.gsub(msg.to.print_name, "_", " ").. "\n#SuperGroup_ID: "..msg.to.id.."\nBot : GrenadeBot"
			end
		end
		...
		if matches[1] == 'help' and not is_owner(msg) then
			text = "This command not work in supergroups For Mods And Users!Send /superhelp in this group or in private for @GrenadeBot Or Call Owner To Use /Help Command"
